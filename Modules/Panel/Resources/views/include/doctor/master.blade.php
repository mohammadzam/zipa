        ...
        <ul class="metismenu left-sidenav-menu">
            ...
            <li>
                <a href="javascript: void(0);">
                    ...
                    <span>{{trans('panel::panel.doctor-menu')}}</span>
                ...
                <ul class="nav-second-level" aria-expanded="true">
                    <li class="nav-item">
                        <a class="nav-link" href="{{route('doctor.show.my.information')}}">
                            <i class="ti-control-record"></i>{{trans('panel::panel.information')}}
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{route('doctor.getMyWorkPlan')}}">
                            <i class="ti-control-record"></i>{{trans('panel::panel.myWorkPlan')}}
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{route('doctor.getMyVisits')}}">
                            <i class="ti-control-record"></i>{{trans('panel::panel.MyVisits')}}
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{route('doctor.getMySicks')}}">
                            <i class="ti-control-record"></i>{{trans('panel::panel.MySicks')}}
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{route('doctor.showSelectRangeDatePage')}}">
                            <i class="ti-control-record"></i>{{trans('panel::panel.salaryReceipt')}}
                        </a>
                    </li>
                </ul>
            </li>

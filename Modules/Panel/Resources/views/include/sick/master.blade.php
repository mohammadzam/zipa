        ...
        <ul class="metismenu left-sidenav-menu">
            ...
            <li>
                <a href="javascript: void(0);">
                    ...
                    <span>{{trans('panel::panel.sick-menu')}}</span>
                ...
                <ul class="nav-second-level" aria-expanded="true">
                    <li class="nav-item">
                        <a class="nav-link" href="{{route('sick.show.my.information')}}">
                            <i class="ti-control-record"></i>{{trans('panel::panel.information')}}
                        </a>
                        <a class="nav-link" href="{{route('sick.show.my.medical.information.index')}}">
                            <i class="ti-control-record"></i>{{trans('panel::panel.medicalInformation')}}
                        </a>
                        <a class="nav-link" href="{{route('sick.my.time')}}">
                            <i class="ti-control-record"></i>{{trans('panel::panel.Reservation')}}
                        </a>
{{--                        <a class="nav-link" href="{{route('sick.my.payments')}}">--}}
{{--                            <i class="ti-control-record"></i>{{trans('panel::panel.myPayments')}}--}}
{{--                        </a>--}}
                    </li>
                </ul>
            </li>
            ...
            <ul class="list-unstyled topbar-nav float-end mb-0">
                ...
                <li class="dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                        ...
                        <form id="logout-form" action="{{ route('sick.logout') }}" method="POST" class="d-none"> @csrf </form>
                    </div>
                </li>
            </ul>
            <!--end topbar-nav-->

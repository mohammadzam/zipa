                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item ">{{trans('admin::admin.doctors index')}}</li>
                                <li class="breadcrumb-item active">{{trans('admin::admin.doctor_time')." ".$doctor->name}}</li>
                            </ol>
                        </div>
                        <!--end col-->
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped mb-0">
                                ...
                                <tr class="text-center">
                                    ...
                                    @else
                                        <td colspan="{{$colspan+1}}" class="text-danger">  دكتر ({{$doctor->name}}) در اين روز شيفت ندارد</td>

                                ...
                                <div class="table-responsive project-invoice">
                                    <table class="table table-bordered mb-0">
                                        ...
                                        <tr>
                                            ...
                                            <th>{{trans('admin::admin.section_name')}}</th>
                                        ...
                                        <tr class="text-center">
                                            ...
                                            <td>
                                                <h5 class="mt-0 mb-1 font-14">{{$data[$i]->section->name}}</h5>
                                            </td>
                                            <td>
                                        ...
                                        @else
                                            <tr class="text-center">
                                                <td colspan="7">
                                                    <h5 class="mt-0 mb-1 font-14 text-danger">هنوز عملى انجام نشده</h5>
                                                </td>
                                            </tr>
                                        @endif
                                        <!--end tr-->
                                    ...
                                    <div class="text-center mt-4">
                                        <small class="font-14 text-primary" >
                                            تفكيك هزينه هاى عمل هاى جراحى
                                        </small>
                                    </div>
                                    <table class="table table-bordered mt-2">
                                        <thead class="thead-light text-center">
                                        <tr>
                                            <th>{{trans('admin::admin.count_of_all_operations')}}</th>
                                            <td>
                                                <h5 class="mt-0 mb-1 font-14">{{$data->count()}} عمل </h5>
                                            </td>
                                        </tr>
                                        <tr>
                                            <th>{{trans('admin::admin.price_of_all_operations')}}</th>
                                            <td>
                            ...
                            <div class="col-lg-6">
                                ...
                                <ul class="ps-3">
                                    <li><small class="font-12 text-secondary">
                                            <span class="font-14 text-primary">اين آمار شامل تعداد همه عمل هاى جراحى انجام وپرداخت شده در همه بخش ها مى باشد</span>

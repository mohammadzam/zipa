                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item ">{{trans('panel::panel.appointment costs')}}</li>
                            ...
                            <div class="col-lg-6">
                                ...
                                <ul class="ps-3">
                                    <li><small class="font-12 text-secondary">
                                            <span class="font-14 text-primary">اين آمار شامل تعداد همه ويزيت هاى پزشکى انجام وپرداخت شده نزد پزشک ({{$doc->name??'هنوز تعيين نشده'}}) مى باشد</span>

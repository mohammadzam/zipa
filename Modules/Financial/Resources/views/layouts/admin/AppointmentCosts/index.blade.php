        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-sm-12 text-left mb-4">
                    <a  href="{{route('admin.appointment.costs.invoice')}}" class="btn btn-primary px-4">مشاهده فاكتور كل هزينه هاى ويزيت دكتر</a>
                </div>
                                ...
                                <table class="table table-striped mb-0">
                                    ...
                                    <tr class="text-center">
                                        ...
                                        <td class="d-flex justify-content-around align-items-center" style="height: 47px">
                                            <a href="{{route('admin.doctorVisitsInvoice',$datum->doctor->id)}}">

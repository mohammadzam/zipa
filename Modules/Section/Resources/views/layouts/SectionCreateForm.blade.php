            ...
            <div class="row">
                <div class="col">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">{{trans('admin::admin.create_new_section')}}</li>
                    </ol>
                </div>
                <!--end col-->
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="row align-items-center">
                            <div class="col">
                                <h4 class="card-title">{{trans('admin::admin.Section information')}}</h4>
                            </div>
                            <!--end col-->
                        </div>
                        <!--end row-->
                    ...
                    <div class="card-body">
                            ...
                            @endif
                        <form method="POST" action="{{route('admin.store.new.section')}}" enctype="multipart/form-data">
                            @csrf

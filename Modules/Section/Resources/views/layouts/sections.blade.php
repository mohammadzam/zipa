        ...
        <div class="container-fluid">
            ...
            <div class="row">
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">{{trans('admin::admin.sections index')}}</li>
                                </ol>
                            </div>
                            <!--end col-->
                ...
                <div class="col-sm-12 text-left mb-4">
                    <a  href="{{route('admin.create.new.section')}}" class="btn btn-primary px-4">{{trans('admin::admin.create_new_section')}}</a>
                </div>
                                ...
                                <table class="table table-striped mb-0">
                                    ...
                                    <tr class="text-center">
                                        ...
                                        <td class="d-flex justify-content-around align-items-center" style="height: 47px">
                                            <a href="{{route('admin.show.edit.form.section',$datum->id)}}">
                                                <i class="las la-pen text-info font-18"></i>
                                            </a>
                                            <a href="#">
                                                <i class="las la-eye text-success font-18"></i>
                                            </a>
{{--                                            <a href="{{route('admin.destroy.section',$datum->id)}}">--}}

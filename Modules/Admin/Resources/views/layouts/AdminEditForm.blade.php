                ...
                <div class="col">
                    ...
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item">
                            <a href="javascript:void(0);">{{trans('admin::admin.admins')}}</a>
                        </li>
            ...
            <div class="col-lg-12 col-xl-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        @endif
                        <form method="POST" action="{{route('admin.update.edited.admin',$data->id)}}" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group row">
                                <label class="col-xl-3 col-lg-3 col-form-label">{{trans('admin::admin.administrative_number')}}</label>
                                <div class="col-lg-9 col-xl-8">
                                    <input class="form-control" name="administrative_number" type="text" value="{{$data->administrative_number}}" placeholder="{{trans('admin::admin.administrative_number')}}" disabled>
                                </div>
                            </div>
                            <div class="form-group row">

            ...
            <div class="row">
                <div class="col">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">{{trans('admin::admin.create_new_admin')}}</li>
                    </ol>
                </div>
                <!--end col-->
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                            ...
                            @if($errors->has('role_id'))
                                    ...
                                    <div class="alert alert-danger alert-dismissible fade show" role="alert">
                                        <span class="alert-text"><strong>{{trans('admin::validation.Error!')}}</strong> {{ $errors->first('role_id') }}</span>
                                        <button type="button" class="btn-close" data-bs-dismiss="alert"
                                                aria-label="Close">
                                            <span aria-hidden="true"></span>
                                        </button>
                            ...
                            @if($errors->has('status'))
                                ...
                                @endif
                        <form method="POST" action="{{route('admin.store.new.admin')}}" enctype="multipart/form-data">
                            @csrf

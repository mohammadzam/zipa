                                ...
                                <ul class="ps-3">
                                    <li>
                                        <small class="font-12 text-secondary">
                                            <span class="font-14 text-primary">هزينه شامل همه موارد اعم از هزينه درمان وهزينه دارو وهزينه بسترى در كلينك مى باشد</span>

                                        </small>
                                    </li>
                                    <li>
                                        <small class="font-12 text-secondary">
                                            <span class="font-14 text-primary">در صورت عدم پرداخت هزينه عمل لطفا در اسرع زمان ممكن وحد اكثر تا 24 ساعت قبل از تاريخ عمل آن را پرداخت كنيد  </span>
                            ...
                            <div class="col-lg-12 col-xl-4 ms-auto align-self-center">
                                ...
                                <div class="text-center">
                                    <small class="font-12 text-primary" >
                                        برای شما آرزوی سلامتی و تندرستی روز افزون داریم
                                    </small>
                                </div>
                            </div>
                            <!--end col-->

        ...
        <div class="row row-eq-height">
            <div class="col-lg-8 col-md-12 col-sm-12 order-lg-1 order-2">
                <div class="beh-card carddetail">
                    ...
                    <div class="card-body">
                            <form method="POST" class="card-info" action="{{route('sick.pay.visit.amount',$id)}}" enctype="multipart/form-data">
                                @csrf
                    ...
                    <div class="card-body">
                        ...
                        <div class="merchant-container">
                            <ul class="col-lg-12 col-sm-8 merchant-detail mb-4">
                                ...
                                <li>نام پرداخت كننده : <b>{{$sick->name}}</b></li>
                                <li>شرح عمليت پرداخت  : <span class="font-weight-bold">بابت رزرو ويزيت نزد دكتر {{$data->doctor->name??'بى نام'}}</span></li>
                        ...
                        <ul class="merchant-detail price">
                            <li>مبلغ قابل پرداخت :<b class="price-number">{{number_format($data->price)}} &nbsp; ریال</b></li>
                        </ul>
                    </div>

! function(n) {
    ...
    function a() {
        n(window).width() < 1300 ? n("body").addClass("enlarge-menu enlarge-menu-all") : n("body").removeClass("enlarge-menu enlarge-menu-all")
    }! function() {
        ...
        function e(a, t, e) {
            var n = "",
                s = "";
            t - a < 100 || "Today" == e ? (n = "Today:", s = a.format("MMM D")) : "Yesterday" == e ? (n = "Yesterday:", s = a.format("MMM D")) : s = a.format("MMM D") + " - " + t.format("MMM D"), i.find("#Select_date").html(s), i.find("#Day_Name").html(n)
        }
    ...
    }), a(), n(".main-icon-menu .nav-link").on("click", function(a) {
        n("body").removeClass("enlarge-menu"), a.preventDefault(), n(this).addClass("active"), n(this).siblings().removeClass("active"), n(".main-menu-inner").addClass("active");
        ...
        var a = window.location.href.split(/[?#]/)[0];
        this.href == a && (n(this).parent().addClass("active"), n(this).parent().parent().parent().addClass("active"), n(this).parent().parent().parent().parent().parent().addClass("active"))
    }), n(".navbar-toggle").on("click", function(a) {
        n(this).toggleClass("open"), n("#navigation").slideToggle(400)
    }), n(".navigation-menu>li").slice(-2).addClass("last-elements"), n('.navigation-menu li.has-submenu a[href="#"]').on("click", function(a) {
        n(window).width() < 992 && (a.preventDefault(), n(this).parent("li").toggleClass("open").find(".submenu:first").toggleClass("open"))
    }), Waves.init()
}(jQuery);